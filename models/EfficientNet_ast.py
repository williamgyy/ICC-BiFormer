...
from utils import preprocess_csv, preprocess_csv_ori,preprocess_csv_bin, get_mean_std
from torch.utils.data import Dataset, DataLoader
from tqdm import tqdm

device1 = torch.device('cuda:2')
base_path = "/home/ubuntu/Desktop/ly/astronomy/data/train0202"
weight_path = 'efficientnet_v2_l64_bin' + str(batch_size) + '_0202' + '.pth'
...
# 加载预训练的resnet18模型
model = torchvision.models.efficientnet_v2_l(pretrained=True)  # 加载预训练的模型
model.classifier[1] = nn.Sequential(nn.Linear(model.classifier[1].in_features, 100),
                                    nn.Dropout(0.5),
                                    nn.Linear(100, 1),
