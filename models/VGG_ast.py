...
weight_path = 'vgg_ast_bin' + str(batch_size) + '_0202' + '.pth'
...
# 加载预训练的VGG16模型
model = torchvision.models.vgg11(pretrained=True)  # 加载预训练的模型

model.classifier[6] = nn.Sequential(nn.Linear(model.classifier[6].in_features, 1),
